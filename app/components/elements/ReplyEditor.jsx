...
class ReplyEditor extends React.Component {
    ...
    constructor() {
        super()
        this.state = {payoutType: (localStorage.getItem('defaultPayoutType') || '100%')}
    ...
    render() {
        ...
        const replyParams = {
            ...
            jsonMetadata, metaLinkData, autoVote: autoVoteValue, payoutType,
                        ...
                        <div className={vframe_section_shrink_class}>
                            ...
                            {isStory && !isEdit && <div className="ReplyEditor__options float-right text-right">
                                ...
                                <select value={this.state.payoutType} onChange={this.onPayoutTypeChange}>
                                    <option value="100%">Power Up All</option>
